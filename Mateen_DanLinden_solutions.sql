...
-- Query: SELECT COUNT(location) FROM subjects;
-- RESULT:
--  count
-- -------
--     15
...
-- Query: SELECT location, COUNT(location) FROM subjects GROUP BY location;
-- RESULT:
--      location     | count
-- ------------------+-------
--                   |     0
...
-- Query: SELECT e.book_id, b.title, COUNT(e.book_id) FROM editions e INNER JOIN books b ON e.book_id=b.id GROUP BY b.title, e.book_id;
-- RESULT:
--  book_id |            title            | count
-- ---------+-----------------------------+-------
