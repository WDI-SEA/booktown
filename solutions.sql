...
SELECT title FROM books b INNER JOIN subjects s ON b.subject_id = s.id AND s.subject = 'Computers';
-- 7. Find all books and display a result table with ONLY the following columns
-- 	* Book title
-- 	* Author's first name
-- 	* Author's last name
-- 	* Book subject
SELECT DISTINCT b.title, a.first_name, a.last_name, s.subject FROM books b INNER JOIN authors a ON a.id = b.author_id INNER JOIN subjects s ON s.id = b.subject_id;
