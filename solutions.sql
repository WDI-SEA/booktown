...
booktown=# booktown=# select books.id, books.title, count(editions.edition) from books                                                                                  join editions on books.id = editions.book_id                                        group by books.id, books.title;
  id   |            title            | count 
-------+-----------------------------+-------
