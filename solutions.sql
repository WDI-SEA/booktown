...
JOIN subjects ON books.subject_id = subjects.id WHERE subject = 'Computers';
...
SELECT book_id, title, COUNT(edition) FROM books 
JOIN editions ON editions.book_id = books.id GROUP BY book_id, title;